    ...
    "recipes": [
        {
            ...
            "license": "CC BY 3.0", "sourceName": "Foodista", "pricePerServing": 47.18,
            "extendedIngredients": [
                {
                    "id": 1001,
                    ...
                    "originalString": "1/2 cup melted butter",
                ...
                },
                {
                    ...
                    "originalString": "1 1/4 cup buttermilk",
                ...
                },
                {
                    ...
                    "originalString": "1 unbaked 9-inch pie shell (see below)",
                    "originalName": "unbaked 9-inch pie shell (see below)",
                    "amount": 1,
                    "unit": "",
                    "meta": ["(see below)"],
                    "metaInformation": ["(see below)"],
                    "measures":
                    {
                        "us": {
                            "amount": 1,
            ...
            "occasions": [],
            "winePairing": {},
            "instructions": "<ol><li>Preheat oven to 325 degrees.</li><li>Beat eggs slightly and add sugar and flour. Then add melted butter and mix well. Add buttermilk and vanilla and mix.</li><li>Dust the unbaked pie shell with a little bit of flour. Pour batter into shell, and then sprinkle a little more flour on top.</li><li>Bake at 325 degrees until the custard is set, approximately 1 hour.</li></ol>",
            "analyzedInstructions":
                [{
                    "name": "", "steps": [{
                        ...
                        { "id": 20081, "name": "all purpose flour", "image": "flour.png" },
                    ...
                    },
                    {
                        ...
                        "ingredients": [{ "id": 18334, "name": "unbaked pie crust", "image": "pie-crust.jpg" },
                        { "id": 1230, "name": "buttermilk", "image": "buttermilk.jpg" },
                        { "id": 2050, "name": "vanilla", "image": "vanilla.jpg" },
                        { "id": 20081, "name": "all purpose flour", "image": "flour.png" }],
                        "equipment": []
                    },
                    {
                        "number": 3, "step": "Pour batter into shell, and then sprinkle a little more flour on top.",
                        "ingredients": [{ "id": 20081, "name": "all purpose flour", "image": "flour.png" }],
                        "equipment": []
                    },
                    {
                        "number": 4,
...
app.post('/contact', (req, res) => {
    ...
    (async () => {
        ...
        try {
            ...
            let queryText = 'INSERT INTO addresses ("city", "state", "zip", "street") ' +
